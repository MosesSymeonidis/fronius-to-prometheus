...
class CustomCollector(object):
    ...
    def __inverter_output(self, id_, inverter, timestamp, prefix):
        ...
        c.add_metric(value=P_PV, labels=['fronius_GetPowerFlowRealtimeData.inverters.output', 'inverters', f'inverter_{id_}'], timestamp=timestamp)
        return c
    ...
    def __overall_pvs(self, site, timestamp, prefix):
        ...
        c.add_metric(value=P_PV, labels=['fronius_GetPowerFlowRealtimeData.power', 'power', 'photovoltaics'], timestamp=timestamp)
        return c
    ...
    def __overall_grid(self, site, timestamp, prefix):
        ...
        c = GaugeMetricFamily(f'{prefix}fronius_power_W_average', '', labels=['chart', 'family', 'dimension'])
        c.add_metric(value=P_Grid, labels=['fronius_GetPowerFlowRealtimeData.power', 'power', 'grid'], timestamp=timestamp)
        return c
    ...
    def __overall_accumulator(self, site, timestamp, prefix):  # TODO check the accumulator
        ...
        c = GaugeMetricFamily(f'{prefix}fronius_power_W_average', '', labels=['chart', 'family', 'dimension'])
        c.add_metric(value=P_Akku, labels=['fronius_GetPowerFlowRealtimeData.power', 'power', 'accumulator'], timestamp=timestamp)
        return c
    ...
    def __E_Year(self, site, timestamp, prefix):  # TODO check the accumulator
        ...
        c.add_metric(value=E_Year, labels=['fronius_GetPowerFlowRealtimeData.energy.year', 'energy', 'year'], timestamp=timestamp)
        return c
